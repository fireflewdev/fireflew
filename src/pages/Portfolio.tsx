    ...
    return (
        <>
            <ShowcasePage
                ...
                description={
                    <span>
                        Here are some of the projects I've made!{"\n"}{"\n"}These include includes my songs (however, most of these aren't released yet; you can check out what I've published <a target="_blank" rel="noreferrer" href={"https://push.fm/fl/fireflew"}>here</a>), and big projects I've worked on that I'm particularly proud of.{"\n"}{"\n"}There's a lot of information on this page–I dive in pretty deep at times–if you prefer skipping around, use the <b>Contents</b> menu to jump to your desired location.{"\n"}{"\n"}All music here is performed, mixed, and mastered by me (unless otherwise specified).
                    </span>
                }
                sections={[
                    {
